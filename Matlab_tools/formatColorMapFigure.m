...
%     set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
    dim = [6 6];% dimensions, in the units set above; use [6 6] when colorbar is above, [6 5] when it is on the side
...
% one needs to adjust the values of elements 3 and 4 manually
    set(gca, 'Position', [InSet(1:2), 0.99-InSet(1)-InSet(3), .9-InSet(2)-InSet(4)]);% for all other plots
