 function y = Cp_LFIM_NF(t,e,c1,c2)
% t is the reduced temperature T/Tc
y = zeros(size(t));
tc =1;% tc used to distinguish two cases: T/Tc<1 and >1
T66 = 1.85;% temperature of divergence of S66=1/C66 reported by Melcher 1976
...
for i=1:length(t)
    ...
    elseif e~=0
        ...
        Cp_nem_fluct(c1,c2,t(i),T66,T_C);% contribution of nematic fluctuations to Cp above Tc
    end
end
end