 function y = Cp_LFIM_NF_cst_strain(T,Tc,e,c1,c2)
...
for i=1:length(t)
    ...
    elseif e~=0
        y(i) = r^2.*sech(r)^2 ./ D + Cp_HT_cst_strain(c1,c2,t(i),T66,T_C);% mean-field heat capacity
    elseif t(i)>tc 
        y(i) = Cp_HT_cst_strain(c1,c2,t(i),T66,T_C);% contribution of nematic fluctuations to Cp above Tc
    end
end
end