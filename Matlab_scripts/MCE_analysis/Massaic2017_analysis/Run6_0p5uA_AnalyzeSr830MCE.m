load('betamodel.mat')
dataname = "Run6_\0p5uA_2017-08-03.dat";
date = " 03 Aug 2017";
SR830MCE(3)=ImportSR830MCE('Run6_0p5uA_2017-08-03.dat',5e-7);
%%
...
%%
fast = 50e-4;%Fast sweep rate of magnetic field (in Tesla/s)
slow = 30e-4;%Slow sweep rate of magnetic field (in Tesla/s)
