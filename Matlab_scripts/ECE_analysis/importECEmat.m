function importECEmat = importfile(filename, startRow, endRow)
...
%
% Example:
%   IMPORTECEMAT = importfile('20180912_TmAsO4-LS5342-MS180511-IB_EC_vs_T_94p5Hz_0-180Vcompressive_H=1T.txt', 6, 63264);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/09/13 10:39:51
...
importECEmat = [dataArray{1:end-1}];
% times1 = dataArray{:, 1};
% T_PPMSK = dataArray{:, 2};
% R_LKSK = dataArray{:, 3};
% T_LKSK = dataArray{:, 4};
